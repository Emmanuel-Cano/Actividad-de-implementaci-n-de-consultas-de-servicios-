...
public class App {
    public static void main(String[] args) {
        ...
        Ticket t1 = new Ticket(1, "HIGH", "Falla crítica");
        Ticket t2 = new Ticket(2, "NORMAL", "Consulta general");
        Ticket t3 = new Ticket(3, "HIGH", "Corte del servicio");
        Ticket t4 = new Ticket(4, "NORMAL", "Solicitud de info");
        Ticket t5 = new Ticket(5, "NORMAL", "Duda de facturación");
        Ticket t6 = new Ticket(6, "HIGH", "Urgente de cliente VIP");
        ...
        Utils gestor = new Utils(tickets);
